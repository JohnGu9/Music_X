...
const int _kMaxDroppedSwipePageForwardAnimationTime = 700; // Milliseconds.
...
//    return nextRoute is CustomCupertinoPageRoute && !nextRoute.fullscreenDialog;
  ...
  static Widget buildPageTransitions<T>(PageRoute<T> route,
...
class _CupertinoEdgeShadowPainter extends BoxPainter {
  _CupertinoEdgeShadowPainter(this._decoration,
